<template>
  <div class="mainContainer">
    <div class="countdown-container text-center surface-section p-3 border-round mb-5">
  ...
  <Dialog v-model:visible="visibility" :pt="{ root: { class: 'w-12 sm:w-9 md:w-6' } }">
    <div class="flex flex-row">
      <Avatar
        image="https://www.gamespot.com/a/uploads/screen_kubrick/1551/15511094/3388284-game%20news%20update.00_00_38_29.still164.png"
        class="mr-2"
        size="xlarge"
        shape="circle"
      />
      <h3>General Herres</h3>
    </div>
    <div class="dialogContainer flex flex-column justify-content-center">
      <p>Good job. The Omega clearance has been retrieved.</p>
      <p>
        Unfortunately, Hartz-Timor has caught the infiltration in the system and decided to launch
        the attack in three minutes from now.
      </p>
      <p>
        We have no time to install the clearance into our machines, so you will have to stop the
        launch by yourself.
      </p>
      <p>
        You will obtain access to a terminal. It should contain all the information to exclude
        Hartz-Timor from our systems. Type START to begin
      </p>
...
export default {
  ...
  methods: {
    ...
    updateCountdowns() {
      const minutes = Math.floor(this.countdowns / 60)
      const seconds = this.countdowns % 60
